...
class FetchMoviesTask extends AsyncTask<String, Void, MovieInfo[]> {
    ...
    private static final String POPULAR_MOVIES_PATH = "discover/movie";
    private static final String SORT_QUERY = "sort_by";
    private static final String APIKEY_QUERY = "api_key";
    private static final String API_KEY = "699ff746b7269c719d2eb60eb957aca1";
    ...
    private FetchMoviesCompletionListener mListener;

    public FetchMoviesTask(FetchMoviesCompletionListener listener) {
        mListener = listener;
    }
    ...
    protected void onPostExecute(MovieInfo[] movieInfo) {
        if (mListener != null) {
            mListener.fetchMoviesCompleted(movieInfo);
        }
    }
    ...
    public interface FetchMoviesCompletionListener {
        void fetchMoviesCompleted(MovieInfo[] movies);
    }
}
